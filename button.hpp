...
class Button
{
  ...
  Button(int xi,int yi,int widthi,int heighti,string text)
  {
  
  }
  
  Button(int xi,int yi,int widthi,int heighti,string texti,
    string imgOnBtni,string  imgOnClicki)
  {
  
  }
  
  Button(int xi,int yi,int widthi,int heighti,string texti,
      string imgOnBtni,string  imgOnClicki,string imgOnFocusi,
      string imgInactivei)
  {
